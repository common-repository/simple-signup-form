...
[Demo](http://pantherius.com/free-jquery-wordpress-signup-form/) | [jQuery Popup Form](https://1.envato.market/L36NV) | [WordPress Survey](https://1.envato.market/oZGBb)
 ...
 = Pro Version =
 [WordPress Email Subscription Form](http://1.envato.market/R3Q9X) offers:
...
* [W8 Contact Form - Sliding Contact Form for WordPress](https://1.envato.market/0DDdL)
* [Modal Survey - Polls and Quiz](https://1.envato.market/oZGBb)
* [Board Game Accessories](https://boardgameset.com)
...
= 1.6.3.7 =
* Google Plus options deprecated
...
= 1.6.1 =
* fixed few notices on backend
* minor improvements on admin UI
