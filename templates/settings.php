...
?>
	...
	<div style="display:none;" id="new_form_content" class="main_form_container">
	  ...
	  <div>
			...
			<div style="display: none;" class="text thankyou simple_subscription_popup_tooltip" title="Google Plus Client ID">Google Plus Client ID: <input type="text" name="thankyou" class="inputtext thankyou gplusclientid" value="" /></div>
			<div style="display: none;" class="text thankyou simple_subscription_popup_tooltip" title="Google Plus API Key">Google Plus API Key: <input type="text" name="thankyou" class="inputtext thankyou gplusapikey" value="" /></div>
			<div style="clear: both;"></div>
